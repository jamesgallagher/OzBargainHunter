...
- **O12. Threshold window ceiling.** The two-page cap (3.1) gives an observation window of about 30 hours, so **no threshold window can exceed roughly 24 hours**. The owner's original example of "100 upvotes in 7 days" is not supportable. Options: cap windows at ~24 hours; or drop the window entirely on high thresholds and evaluate "reached X votes while visible", which is unaffected by the reach limit. **Needs a decision.**
